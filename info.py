...
BOT_TOKEN = environ.get('BOT_TOKEN', "7633313391:AAE3y4cDVOHDX7K9f4s879x0vN1Np6T3ess")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://telegra.ph/file/1eacda7cd1a1fed59df40.jpg')).split() #SAMPLE PIC
...
STREAM_SITE = (environ.get('STREAM_SITE', 'thunderlinks.site'))
STREAM_API = (environ.get('STREAM_API', '6bb70596130a14d8dbe83f991482095b52179b18'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002129873612') #Channel / Group Id for force sub ( make sure bot is admin )
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://PREDVD:PREDVD@cluster0.xh6fkkd.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
SHORTLINK_API = environ.get('SHORTLINK_API', '6bb70596130a14d8dbe83f991482095b52179b18')
...
MSG_ALRT = environ.get('MSG_ALRT', 'ᴋᴀɴɴᴀᴅᴀᴍᴀɢᴀᴀ : KannadaMagaa')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002051915731')).split()]
...
URL = "https://leading-anthea-kannadamovie.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://leading-anthea-kannadamovie.koyeb.app/:8000/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://leading-anthea-kannadamovie.koyeb.app/".format(FQDN)
else:
    URL = "http://leading-anthea-kannadamovie.koyeb.app/".format(FQDN)
